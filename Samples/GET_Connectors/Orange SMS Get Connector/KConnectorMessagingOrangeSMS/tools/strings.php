...
namespace KiamoConnectorSampleToolsOrangeSMS ;
...
class Strings
{
  ...
  function strEndsWith( &$str, &$searchStr, $caseInsensitive = false )
  {
    $_str       = $str ;
    $_searchStr = $searchStr ;
    if( $caseInsensitive === true )
    ...
    return $_searchStr === "" || ( ( $temp = strlen( $_str ) - strlen( $_searchStr ) ) >= 0 && strpos( $_str, $_searchStr, $temp ) !== false ) ;
  }
