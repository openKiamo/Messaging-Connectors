...
![Page Creation](https://github.com/openKiamo/Messaging-Connectors/blob/master/Samples/_Docs/data/TW_0101_CreatePage.png)
...
![Direct Messages Setup](https://github.com/openKiamo/Messaging-Connectors/blob/master/Samples/_Docs/data/TW_0102_CreatePage.png)
...
![App Permissions](https://github.com/openKiamo/Messaging-Connectors/blob/master/Samples/_Docs/data/TW_0201_CreateApp.png)
...
![App Keys and Tokens](https://github.com/openKiamo/Messaging-Connectors/blob/master/Samples/_Docs/data/TW_0202_CreateApp.png)
...
![Connector Configuration](https://github.com/openKiamo/Messaging-Connectors/blob/master/Samples/_Docs/data/TW_0301_ConnectorConfiguration.png)
...
* use the package provided Command Line Tester :
  ...
  * either using the users show API, through the test #04 :
    ...
    * enter your Twitter page name :
      ...
      ![Command Line Tester : screen_name](https://github.com/openKiamo/Messaging-Connectors/blob/master/Samples/_Docs/data/TW_0401_GetUserId.png)

    * run the test #04 of the Command Line Tester on a Command Line Console :

      ![Command Line Tester : run](https://github.com/openKiamo/Messaging-Connectors/blob/master/Samples/_Docs/data/TW_0402_GetUserId.png)
